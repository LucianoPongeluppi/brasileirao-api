...
public class RessourceExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<StandardError> unauthorized(UnathorizedException e, HttpServletRequest request){
	...
	public ResponseEntity<StandardError> internalSeverErrorException(InternalServerErrorException e, HttpServletRequest request){
